...
| `开发 v0.9`、`实现 v0.9`、`继续 v0.9`、`/goal 开发 v0.9`、`/goal 开发完整验证套件` | `docs/milestones/v0.9-complete-worldengine-validation-suite/` | `README.zh.md`、`gap-analysis.zh.md`、`phased-validation-plan.zh.md`、`phased-validation-runbook.zh.md`、`scenario-matrix.zh.md`、`artifact-contract.zh.md`、`plan.zh.md`、`implementation-task-plan.zh.md`、`validation.zh.md`、`review.zh.md` |
| `自主验证 v0.9`、`Codex 验证 v0.9`、`Agent 验证 v0.9`、`运行完整验证套件` | `docs/milestones/v0.9-complete-worldengine-validation-suite/` | `README.zh.md`、`phased-validation-plan.zh.md`、`phased-validation-runbook.zh.md`、`scenario-matrix.zh.md`、`artifact-contract.zh.md`、`plan.zh.md`、`implementation-task-plan.zh.md`、`validation.zh.md`、`review.zh.md` |
